...
{
   char nameCur[itemNameSize];
   char namePrev[itemNameSize];
   ...
   PcBoard *m_board;
public:
   SetPropsCommand(SmartPtr<GraphicalItem>& p,shared_ptr<PointF>& pos,
                   shared_ptr<GeomCommonProps>& props,PcBoard *pBoard,
                   const char *pName);
